...
routerAdd('GET', '/backend/v1/propostas/public/{token}', (e) => {
  ...
  try {
    ...
    const resp = {
      ...
      desconto_percentual: proposta.getFloat('desconto_percentual') || 0,
      valor_desconto: proposta.getFloat('valor_desconto') || 0,
      valor_bruto: proposta.getFloat('valor_bruto') || proposta.getFloat('preco_venda'),
